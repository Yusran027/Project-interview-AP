                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label class="font-weight-bold">Descrtiption</label>
                                <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" rows="5" placeholder="Masukkan Deskripsi Produk" style="resize: none;">{{ old('description') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('size') is-invalid @enderror" name="size" value="{{ old('size') }}" placeholder="Masukkan size Product">
                            ...
                            <button type="reset" class="btn btn-md btn-danger">Void</button>
